...
/*     */   
/*     */   boolean hasExtra() {
/* 152 */     return (this.extra.length > 0);
/*     */   }
/*     */   
...
/* 161 */     return this.localHeaderOffset;
/*     */   }
/*     */ 
/*     */   
/*     */   public CentralDirectoryFileHeader clone() {
/* 166 */     byte[] header = new byte[46];
/* 167 */     System.arraycopy(this.header, this.headerOffset, header, 0, header.length);
/* 168 */     return new CentralDirectoryFileHeader(header, 0, this.name, header, this.comment, this.localHeaderOffset);
/*     */   }
/*     */ 
/*     */   
...
/* 173 */     CentralDirectoryFileHeader fileHeader = new CentralDirectoryFileHeader();
/* 174 */     byte[] bytes = data.read(offset, 46L);
/* 175 */     fileHeader.load(bytes, 0, data, offset, filter);
/* 176 */     return fileHeader;
/*     */   }
/*     */ }


/* Location:              C:\Users\olatu\OneDrive\Documents\Calypso\syncbase\sync_base.jar!\org\springframework\boot\loader\jar\CentralDirectoryFileHeader.class
